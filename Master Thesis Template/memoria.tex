...
%------------------ Fonts ------------------
\usepackage{charter} % Palatino-style font (serif)
\usepackage[scaled]{beramono} % Nicer monospaced font for listings
...
% Estilo de código para C++ con resaltado mejorado
\lstdefinestyle{cppstyle}{
    ...
    xleftmargin=15pt,                               
    xrightmargin=15pt,
    morekeywords={longlong, uint, undefined8, int, char, double, float, void, class, struct, return, const, static, public, private, protected, namespace, virtual, uint64_t, Entity_t, new, delete, template, inline, friend, typeid}, % Palabras clave adicionales
    sensitive=true,                                     
    literate={\&\&}{\textcolor{operatorcolor}{\&\&}}1 {\|\|}{\textcolor{operatorcolor}{||}}1 
}
...
%------------------ Bibliography (APA) ------------------
\usepackage[style=apa, backend=biber, natbib=true, hyperref=true]{biblatex}
