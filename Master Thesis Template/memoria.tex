...
\lstdefinestyle{cppstyle}{
    ...
    xleftmargin=15pt,                               
    xrightmargin=15pt,
    morekeywords={longlong, uint, undefined8, int, char, double, float, void, class, p, return, const, static, public, private, protected, namespace, virtual, uint64_t, Entity_t, new, delete, template, inline, friend, typeid}, % Palabras clave adicionales
    sensitive=true,                                     
