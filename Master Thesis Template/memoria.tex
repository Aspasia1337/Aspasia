...
\definecolor{framegray}{rgb}{0.65, 0.65, 0.65}
...
\input{text/ch1.tex} % Introduction
\input{text/ch2.tex} % Introduction
\input{text/ch3.tex} % Introduction
\input{text/ch4.tex} % Introduction
\input{text/ch5.tex} % Introduction
