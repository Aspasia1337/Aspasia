...
Figure~\ref{fig:cs2-growth} visualizes the evolution of the CS2 player base from January 2024 to March 2025, including both average and peak monthly player counts based on publicly available statistics.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xtick=data,
      xticklabels={
        Jan '24, Feb, Mar, Apr, May, Jun, Jul, Aug,
      ...
      xlabel={\small Month},
      ylabel={\small Players},
      xlabel style={font=\small, yshift=6pt},
      ylabel style={font=\small, yshift=-4pt},
      title={\small\bfseries CS2 Monthly Player Growth (Jan 2024 – Mar 2025)},
    ...
    \addplot[
      blue,
      mark=*,
      mark options={scale=0.8, fill=blue!50},
    ] coordinates {
      (0,760859.2) (1,786630.8) (2,885629.7) (3,930749.0) (4,958207.3) (5,947520.5) 
      (6,875365.1) (7,897337.9) (8,836306.7) (9,829438.8) (10,852164.3) (11,913953.4) 
      (12,914092.2) (13,1003570.6) (14,1040008.9)
    };
    ...
    \addplot[
      red,
      mark=triangle*,
      mark options={scale=1, fill=red!50},
    ] coordinates {
      (0,1277907) (1,1347519) (2,1521796) (3,1618685) (4,1614925) (5,1510840)
      (6,1342171) (7,1425958) (8,1473144) (9,1484045) (10,1556938) (11,1740261)
      (12,1594016) (13,1783434) (14,1818368)
    };
    \addlegendentry{Peak Players}
  
    \end{axis}
  \end{tikzpicture}
  \caption{Counter-Strike 2 player count evolution from January 2024 to March 2025.}
