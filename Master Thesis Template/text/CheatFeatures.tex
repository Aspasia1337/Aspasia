...
After validating Chams on enemies, we extended material overrides to the local player's hands and weapon. Thanks to our entity filter, each model type, enemy, weapon, or arms, can receive a distinct material independently.
