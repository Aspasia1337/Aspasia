...
\textbf{nProtect GameGuard}, launched in 2001, was among the first anti-cheat solutions to employ rootkit-like behavior. Widely used in Asian MMORPGs, it integrates deeply into the operating system, operating at the kernel level (ring 0), to prevent cheats from interacting with game processes. This deep integration has raised concerns about privacy and system stability \parencite{nprotect_wikipedia}.
...
Finally, \textbf{VAC Live}, unveiled in 2023, represents Valve's shift toward real-time, data-driven cheat prevention. Unlike the original VAC system, which relied on delayed bans, VAC Live aims to detect and react to cheats during gameplay, making it a critical component in safeguarding the integrity of high-stakes esports matches \parencite{vac_live_announcement}.
...
Having explored the historical and sociotechnical evolution of video game cheating from its inception with debugging tools to its current status as a sophisticated, commercialized industry we now shift our focus to the contemporary market dynamics and their ramifications on gaming communities.

The subsequent chapters will delve into the economic structures underpinning the cheating industry, examining how monetized cheating services influence player behavior, community trust, and the overall integrity of online gaming environments. By analyzing these market forces, we aim to elucidate the broader social and economic impacts of cheating within the gaming ecosystem.

With the historical framework established, we proceed to assess the market-driven aspects that perpetuate and shape the landscape of video game cheating.
\newpage
