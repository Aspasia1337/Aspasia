...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{3.2cm}|c|p{4cm}|p{3.8cm}|}
        ...
        \hline
        \textbf{Neverlose} \parencite{neverlose2020} & 2020 & €17.10/month, €44.10/3 months, €134.10/year & Invite-only \\
        \hline
        \textbf{Memesense} \parencite{memesense2023} & 2023 & \$4/14 days, \$8/month, \$12/3 months & Public access \\
        \hline
        \textbf{Fatality.win} \parencite{fatality2022} & 2022 & Premium pricing (variable) & Invite-only \\
        \hline
        \textbf{Project Infinity} \parencite{projectinfinity2017} & 2017 & €14.99/month, €29.99/3 months, €99.99 lifetime & Public access \\
        \hline
        \textbf{Midnight} \parencite{midnight2019} & 2019 & £5.42/month & Public access \\
        \hline
        \textbf{Onetap} \parencite{onetap2024} & 2024 & Pricing not publicly disclosed & Public access \\
        \hline
        \textbf{Skeet (Gamesense)} \parencite{skeet2016} & 2016 & \$16/month (via tokens, fluctuating) & Invite-only + HWID locked \\
        \hline
    \end{tabular}
