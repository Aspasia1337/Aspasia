...
\begin{frame}
    \frametitle{VAC and Valve Anti-Cheat Visuals}
    \begin{center}
        \begin{minipage}[t]{0.48\linewidth}
            \centering
            \animategraphics[height=5.2cm,autoplay,loop]{10}{images/images/valve-anticheat-frisk/frame_}{00}{62}
            
            \vspace{0.2cm}
            {\footnotesize\textbf{Frisk Meme (Valve Anti-Cheat)}}
        \end{minipage}
        \hspace{-0.1\linewidth} % Ajusta este valor si hace falta
        \begin{minipage}[t]{0.48\linewidth}
            \centering
            \animategraphics[height=5.2cm,autoplay,loop]{10}{images/images/vac-valve/frame_}{00}{62}
            
            \vspace{0.2cm}
            {\footnotesize\textbf{Door Meme (VAC Bypass)}}
        \end{minipage}
    \end{center}
\end{frame}
